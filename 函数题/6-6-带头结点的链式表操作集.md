...
int main()
{
    ...
    while ( N-- ) {
        ...
        if ( flag==false ) cout << "Wrong Answer\n";
    }
    cin >> N;
    while ( N-- ) {
        cin >> X;
    ...
    flag = Insert(L, X, P);
    if ( flag==true ) cout << "Wrong Answer\n";
    flag = Delete(L, P);
    if ( flag==true ) cout << "Wrong Answer\n";
...
bool Insert(List L, ElementType X, Position P) {
    ...
    if (!prev) { cout << "Wrong Position for Insertion\n"; return false; }
    Position node = new struct LNode;
    node->Data = X; node->Next = P;
    prev->Next = node;
    return true;
}

bool Delete(List L, Position P) {
    if (!P) { cout << "Wrong Position for Deletion\n"; return false; }
    Position prev = L;
    while (prev && prev->Next != P) prev = prev->Next;

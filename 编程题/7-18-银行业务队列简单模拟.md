...
int main(){
    ...
    int n;cin>>n;queue<int>a,b;
    for(int i=0,x;i<n;++i){cin>>x;(x%2?a:b).push(x);}
    bool first=true;
    auto print=[&](int x){if(!first)cout<<' ';cout<<x;first=false;};
    while(!a.empty()||!b.empty()){
        if(!a.empty())print(a.front()),a.pop();
        if(!a.empty())print(a.front()),a.pop();
        if(!b.empty())print(b.front()),b.pop();
    }
    cout<<'\n';
}
```
